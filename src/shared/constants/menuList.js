...
const menuList = [
  ...
  { id: 14, icon: faLock, text: 'Документи КТ' },
  { id: 15, icon: faCheckSquare, text: 'Узгодження документів' },
  { id: 16, icon: faReplyAll, text: 'Виконання документів' },
  { id: 17, icon: faEye, text: 'Контроль' },
  { id: 18, icon: faExchange, text: 'Рух документів' },
  { id: 19, icon: faListAlt, text: 'Реєстри передач' },
  { id: 20, icon: faPieChart, text: 'Звіти' },
  { id: 21, icon: faBook, text: 'Конструктор звітів' },
  { id: 22, icon: faSearch, text: 'Пошук' },
];
